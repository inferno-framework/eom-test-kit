module EOMTestKit
    class EOMReadCancerPatientProfileTest < Inferno::Test
        id :eom_read_cancer_patient_test
        title 'Receive EOM Cancer Patient Resource'
        description %(
